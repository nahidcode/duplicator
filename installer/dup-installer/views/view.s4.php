...
<form id='s4-input-form' method="post" class="content-form" style="line-height:20px">
	...
	<i style="color:maroon; font-size:12px">
		<b><i class="fa fa-exclamation-triangle"></i> IMPORTANT FINAL STEPS:</b> Login to this sites WordPress Admin to be prompted to remove all
		...
		and keep this site secure.   This install is NOT complete until all installer files are removed.  Leaving the installer files on this server can lead to security issues.
	</i>
	<br/><br/><br/>
