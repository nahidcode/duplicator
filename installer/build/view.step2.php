	...
	<div id="ajaxerr-area" style="display:none">
	    ...
	    <div style="padding: 0px 10px 10px 0px;">
			...
			<div style="text-align:center; margin:10px auto 0px auto">
				...
				<i style='font-size:11px'>See online help for more details at <a href='https://snapcreek.com/ticket?utm_source=duplicator_free&utm_medium=wordpress_plugin&utm_campaign=error_resolution&utm_content=inst_ajaxstep2_ticket' target='_blank'>snapcreek.com</a></i>
			</div>
	    </div>
	</div>
</form>
...
DUPX.runDeployment = function()
{
	...
	$.ajax({
		...
		error: function(xhr) {
			...
			status += "- For timeout issues visit the <a href='https://snapcreek.com/duplicator/docs/faqs-tech/?utm_source=duplicator_free&utm_medium=wordpress_plugin&utm_campaign=error_resolution&utm_content=inst_step2deploy_timout#faq-trouble-100-q' target='_blank'>Timeout FAQ Section</a><br/>";
