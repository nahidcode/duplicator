...
<form id='s4-input-form' method="post" class="content-form" style="line-height:20px">
			...
			<div class="info-error">
				...
				<ul>
					<li>
						...
						<a href="https://snapcreek.com/duplicator/docs/faqs-tech/?utm_source=duplicator_free&utm_medium=wordpress_plugin&utm_campaign=error_resolution&utm_content=inst_step4_unknowncoll#faq-trouble-090-q" target="_blank">What is Compatibility mode & 'Unknown collation' errors?</a>
					</li>
					<li>
	...
	<div class='s4-connect'>
		...
		<a href='https://snapcreek.com/duplicator/docs/faqs-tech/?utm_source=duplicator_free&utm_medium=wordpress_plugin&utm_campaign=error_resolution&utm_content=inst4_step4_troubleshoot' target='_blank'>FAQs</a>
	</div><br/>
</form>
