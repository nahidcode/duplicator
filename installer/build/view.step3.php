	...
	<div id="ajaxerr-area" style="display:none">
		...
		<div style="padding: 0px 10px 10px 10px;">
			...
			<div style="text-align:center; margin:10px auto 0px auto">
				...
				<i style='font-size:11px'>See online help for more details at <a href='https://snapcreek.com/ticket?utm_source=duplicator_free&utm_medium=wordpress_plugin&utm_campaign=error_resolution&utm_content=inst_step3_ajax' target='_blank'>snapcreek.com</a></i>
			</div>
		</div>
	</div>
</form>
...
DUPX.runUpdate = function()
{
	...
	$.ajax({
		...
		error: function(xhr) {
			...
			status += "- For timeout issues visit the <a href='https://snapcreek.com/duplicator/docs/faqs-tech/?utm_source=duplicator_free&utm_medium=wordpress_plugin&utm_campaign=error_resolution&utm_content=inst_step3_ajax_rundepl#faq-trouble-100-q' target='_blank'>Timeout FAQ Section</a><br/>";
