		...
		<table>
			<tr>
				...
				<td valign="top">
					...
					<div class="s3-allnonelinks"  style="<?= (isset($_POST['safe_mode_installer']) && ($_POST['safe_mode_installer']==1 || $_POST['safe_mode_installer']==2))? 'display:none':''; ?>">
					...
					<select id="plugins" name="plugins[]" multiple="multiple" style="width:315px; height:100px" <?= (isset($_POST['safe_mode_installer']) && ($_POST['safe_mode_installer']==1 || $_POST['safe_mode_installer']==2))? 'disabled="disabled"':''; ?>>
						<?php
