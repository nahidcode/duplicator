...
//        $this->validationType        = $data->validationType;
    ...
    public function save()
    {
        ...
        if($this->currentFileHeader != null) {
            $data->currentFileHeaderString      = SnapLibUtil::wp_json_encode($this->currentFileHeader);
        } else {
            $data->currentFileHeaderString      = null;
        }

        if($this->archiveHeader != null) {
            $data->archiveHeaderString      = SnapLibUtil::wp_json_encode($this->archiveHeader);
        } else {
            $data->archiveHeaderString      = null;
        }

        $data->failuresString = SnapLibUtil::wp_json_encode($this->failures, JSON_FORCE_OBJECT);
