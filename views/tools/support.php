    ...
    <div style="width:800px; margin:auto; margin-top: 20px">
        ...
        <div class="dup-support-hlp-area">
            ...
            <div class="dup-support-hlp-txt">
                ...
                <select id="dup-support-kb-lnks" style="margin-top:18px; font-size:16px; min-width: 170px">
                    ...
                    <option value="https://snapcreek.com/duplicator/docs/quick-start/?utm_source=duplicator_free&utm_medium=wordpress_plugin&utm_campaign=error_resolution&utm_content=support_qs"><?php _e('Quick Start', 'duplicator') ?></option>
                    <option value="https://snapcreek.com/duplicator/docs/guide/?utm_source=duplicator_free&utm_medium=wordpress_plugin&utm_campaign=error_resolution&utm_content=support_guide"><?php _e('User Guide', 'duplicator') ?></option>
                    <option value="https://snapcreek.com/duplicator/docs/faqs-tech/?utm_source=duplicator_free&utm_medium=wordpress_plugin&utm_campaign=error_resolution&utm_content=support_FAQs"><?php _e('FAQs', 'duplicator') ?></option>
                    <option value="https://snapcreek.com/duplicator/docs/changelog/?utm_source=duplicator_free&utm_medium=wordpress_plugin&utm_campaign=error_resolution&utm_content=support_changelog&lite"><?php _e('Change Log', 'duplicator') ?></option>
                </select>
            </div>
        </div>
        ...
        <div class="dup-support-hlp-area">
            ...
            <div class="dup-support-hlp-txt">
				...
				<small>Pro Users <a href="https://snapcreek.com/ticket?utm_source=duplicator_free&utm_medium=wordpress_plugin&utm_campaign=error_resolution&utm_content=support_prousers_here" target="_blank">Support Here</a></small>
            </div>
        </div> 
        ...
        <div class="dup-support-hlp-area">
            ...
            <div class="dup-support-hlp-txt">
                ...
                <div class="dup-support-txts-links">
                    <button class="button button-primary button-large" onclick="window.open('https://snapcreek.com/duplicator/docs/faqs-tech/?utm_source=duplicator_free&utm_medium=wordpress_plugin&utm_campaign=error_resolution&utm_content=support_servers#faq-resource-040-q', 'litg');"><?php _e('Trusted Providers!', 'duplicator') ?></button> &nbsp;
                </div>
            </div>
        </div>
        ...
        <div class="dup-support-hlp-area">
            ...
            <div class="dup-support-hlp-txt">
                ...
                <br/><br/>
                <div class="dup-support-txts-links">
                    <button class="button button-primary button-large" onclick="window.open('https://snapcreek.com/duplicator/docs/faqs-tech/?utm_source=duplicator_free&utm_medium=wordpress_plugin&utm_campaign=error_resolution&utm_content=support_pro_sln#faq-resource-050-q', 'litg');"><?php _e('Pro Solutions!', 'duplicator') ?></button> &nbsp;
                </div>
            </div>
        </div>
    </div>
...
<script>
    jQuery(document).ready(function($) {
        ...
        Duplicator.OpenSupportWindow = function() {
            var url = 'https://snapcreek.com/duplicator/docs/faqs-tech/?utm_source=duplicator_free&utm_medium=wordpress_plugin&utm_campaign=error_resolution&utm_content=support_window#faq-resource';
