...
$err_link_faq		= '<a target="_blank" href="https://snapcreek.com/duplicator/docs/faqs-tech/?utm_source=duplicator_free&utm_medium=wordpress_plugin&utm_campaign=error_resolution&utm_content=pkg_details_faq">' . __('FAQ', 'duplicator') . '</a>';
$err_link_ticket	= '<a target="_blank" href="https://snapcreek.com/duplicator/docs/faqs-tech/?utm_source=duplicator_free&utm_medium=wordpress_plugin&utm_campaign=error_resolution&utm_content=pkg_details_resources#faq-resource">' . __('resources page', 'duplicator') . '</a>';
?>
