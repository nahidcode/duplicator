				...
				<tr>
					<td colspan="4">
						<div class="dup-store-pro"> 
                            ...
                            <a href="https://snapcreek.com/duplicator/?free-storage-detail" target="_blank"><?php _e('Professional', 'duplicator');?></a> 
		...
		<tr class="sub-item <?php echo $css_file_filter_on ?>">
			...
			<td>
				<i>
					...
					<a href="https://snapcreek.com/duplicator/?free-file-filters" target="_blank"><?php _e('Professional', 'duplicator');?></a> 
				</i>
				<i class="fa fa-lightbulb-o" 
