...
jQuery(document).ready(function($) {
	...
	Duplicator.Pack.LoadScanData = function(data) 
	{
		...
		if (data == undefined || data.RPT == undefined)
		{
			...
			html_msg += '<li><?php _e("- On some budget hosts scanning over 10,000 files can lead to timeout/gateway issues. Consider scanning only your main WordPress site and avoid trying to backup other external directories.", 'duplicator') ?></li>';
