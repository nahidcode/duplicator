			...
			<div>
				...
				<div class='dup-scan-info dup-info-box'>
                    ...
                    if ($zip_check != null) {
                            ...
                            echo '</span>';
                            echo "&nbsp;<i><a href='https://snapcreek.com/duplicator?free-max-execution-time-warn' target='_blank'>[" . __('details', 'duplicator') . "]</a></i>";
                    }
					...
					<div class='dup-scan-info  dup-info-box'>
						...
						<?php 
							...
							if ($zip_check != null) {
                                ...
                                echo '</span>';
								echo "&nbsp;<i><a href='https://snapcreek.com/duplicator?free-size-warn' target='_blank'>[" . __('details', 'duplicator') . "]</a></i>";
							}
