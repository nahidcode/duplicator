...
<style>
	...
	div#dup-arc-details-dlg h2 {margin:0; padding: 5px; border-bottom:1px solid #dfdfdf;}
	...
	div#dup-arc-details-dlg div.filter-area {height:220px; overflow-y:scroll; border:1px solid #dfdfdf; padding:8px; margin:2px 0}
	div#dup-arc-details-dlg div.file-info {padding:0 0 10px 15px; width:500px; white-space:nowrap;}
	
	div#dup-arc-paths-dlg textarea.path-dirs,
	...
	div#dup-arc-paths-dlg div.copy-button {float:right;}
	div#dup-arc-paths-dlg div.copy-button button {font-size:12px}
